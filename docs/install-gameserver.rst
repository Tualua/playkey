...
Создайте каталог директорию командой :bash:`mkdir /mnt/playkey`
...
Так же, скопируйте файл */mnt/playkey/usr/local/etc/gameserver/template.xml* в папку */root*

Скопируйте полученный файл в домашнюю папку пользователя root - **/root** и выполните следующую команду:
